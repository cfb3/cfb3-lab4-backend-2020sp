define({ "api": [
  ...
  },
  {
    "type": "put",
    "url": "/auth",
    "title": "Request the pushy push token with the service",
    "name": "PutAuth",
    "group": "Auth",
    "header": {
      "fields": {
        "Header": [
          {
            ...
            "optional": false,
            "field": "authorization",
            "description": "<p>a valid JSON Web Token JWT</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "get",
    "url": "/marvel/characters",
    "title": "Request a single random marvel character",
    "name": "GetMarvelCharacters",
    "group": "Marvel",
    "header": {
      "fields": {
